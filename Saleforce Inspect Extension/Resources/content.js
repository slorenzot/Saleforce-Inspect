...
function addApplicationFooter() {
    ...
    footer.style.backgroundColor = 'rgb(255, 207, 0)'; // Un color de fondo suave, como el amarillo claro
    footer.style.backgroundImage = 'repeating-linear-gradient(45deg, rgba(0,0,0,.3) 0, rgba(0,0,0,.3) 10px, transparent 10px, transparent 20px)';
